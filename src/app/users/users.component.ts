...
export class UsersComponent {
   ...
   clickHandler(){
    ...
    if (!this.emailControl.valid || !this.userNameControl.valid || !this.ageValue.valid || !this.lastNameValue) {
      ...
      Swal.fire({
        title: 'Your Information seccessfuly Send!,You will be transferred to the list of users in five seconds!',
        icon: 'success',
        showClass: {
